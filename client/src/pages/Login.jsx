            ...
            >
                ...
                <div className="bg-[#071320]/85 backdrop-blur-xl border border-[#1e3a5f]/60 rounded-3xl p-8 sm:p-10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] text-left">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full bg-[#0b1b2d] border border-[#1b2f48] text-white placeholder:text-[#475569] rounded-xl pl-11 pr-4 py-3.5 text-sm outline-none focus:border-[#0070f3] focus:ring-1 focus:ring-[#0070f3] transition-all"
                            />
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full bg-[#0b1b2d] border border-[#1b2f48] text-white placeholder:text-[#475569] rounded-xl pl-11 pr-11 py-3.5 text-sm outline-none focus:border-[#0070f3] focus:ring-1 focus:ring-[#0070f3] transition-all"
                            />
                            <button
                                type="button"
                        ...
                        <div className="flex items-center justify-between pt-1 pb-2 text-sm">
                            <label className="flex items-center cursor-pointer select-none">
                                ...
                                />
                                <span className="ml-2.5 text-[#94a3b8] text-sm">Remember me</span>
                            </label>
                            <a href="#forgot" onClick={(e) => { e.preventDefault(); alert("Password reset link will be sent to your email."); }} className="text-[#0091ff] hover:text-blue-400 font-medium transition-colors text-sm">
                                Forgot Password?
                            </a>
                        </div>
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-[#0070f3] hover:bg-[#0060df] text-white font-medium py-3.5 rounded-xl shadow-[0_4px_20px_rgba(0,112,243,0.35)] transition-all active:scale-[0.99] flex items-center justify-center gap-2 text-base disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                            {isLoading ? (
                    ...
                    <button
                        ...
                        className="w-full bg-[#0b1b2d] hover:bg-[#0f233a] border border-[#1b2f48] py-3.5 px-4 rounded-xl flex items-center justify-center gap-3 text-slate-200 text-sm font-medium transition-all active:scale-[0.99] cursor-pointer"
                    >
                        <GoogleIcon />
                    ...
                    {/* Footer Toggle Link */}
                    <div className="mt-8 text-center text-sm text-[#8a99ad]">
                        Don’t have an account?{" "}
                        <Link to="/register" className="text-[#0091ff] font-semibold hover:underline transition-colors ml-0.5">
                            Sign Up
                        </Link>
                    </div>
                </div>
